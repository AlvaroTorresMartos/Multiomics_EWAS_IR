...
######################
######################
###################### TRES FACTORES: OB/OV IR VS OB/OV noIR vs NW no IR
############################################
############################################
...
HOMAOB[ which( HOMAOB == "IR_Sobrepeso_T1" )] <- "IR_Obeso_T1"
HOMAOB[ which( HOMAOB == "NoIR_Sobrepeso_T1" )] <- "NoIR_Obeso_T1"

HOMAOB[ which( HOMAOB == "NoIR_Normopeso_T1" )] <- "NoIRNormopeso"
HOMAOB[ which( HOMAOB == "NoIR_Obeso_T1" )] <- "NoIRSobOb"
HOMAOB[ which( HOMAOB == "IR_Obeso_T1" )] <-"IRSobOb"
...
colnames(factored.design)[1:3] <- c("NoIRNormopeso","NoIRSobOb","IRSobOb")
 colnames(factored.design)[4:13]  <- c("CD8T","CD4T","NK","BCELL","MONO","NEU","SEX","AGE","ORIGEN1","ORIGEN2")
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/RESUMEN_RESULTS_EPIGENETICA_2021/ANALISIS_EXTRA/NoIRNormopesoVSIRSobOb_PREPUBER_adjusted_LEUCOS_AGE_SEX_rawP0001.csv", row.names=FALSE)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/RESUMEN_RESULTS_EPIGENETICA_2021/ANALISIS_EXTRA/NoIRSobObVSIRSobOb_PREPUBER_adjusted_LEUCOS_AGE_SEX_FDR05rawP0001.csv", row.names=FALSE)
