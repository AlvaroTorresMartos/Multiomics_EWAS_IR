...
COVARS_ALL <- POBLACION_EFECTIVA_PUBERtal_CROSS
...
plotMDS(mVals_BMIQ[,which(colnames(mVals_BMIQ) %in% POBLACION_EFECTIVA_PUBERtal_CROSS$Code)], top=1000, gene.selection="common",col=pal[COVARS_ALL$Sex_Time])
...
pal <- brewer.pal(11,"RdBu")[c(2,9)]
plotMDS(mVals_BMIQ[,which(colnames(mVals_BMIQ) %in% POBLACION_EFECTIVA_PUBERtal_CROSS$Code)], top=1000, gene.selection="common",col=pal[factor(COVARS_ALL$BATCH)])
...
#  OB/OW non-IR no change    17
#  OB/OW IR to non-IR         9
#  OB/OW non-IR to IR        12
#  OB/OW IR no change        10
...
COVARS_ALL$Cole_Time[ COVARS_ALL$Cole_Time == "Normopeso_T1"] <- "Normopeso_T2"
COVARS_ALL$Cole_Time[ COVARS_ALL$Cole_Time == "Sobrepeso_T1"] <- "Sobrepeso_T2"
COVARS_ALL$Cole_Time[ COVARS_ALL$Cole_Time == "Obeso_T1"] <- "Obeso_T2"
table(COVARS_ALL$Cole_Time)
#NOTA: HAY 2 SIN DATO
#Normopeso_T2     Obeso_T2 Sobrepeso_T2 
#          47           45           36 

table(COVARS_ALL$HOMA_0_AUG_Time)
#NOTA: NO HAY NINGUNO SIN DATO
#  0  1 
#98 34 
...
MICROARRAY_PREPUBER <- MICROARRAY[,which(!is.na(COVARS_FENOS_CONTINUOS_t0$Cole_Time))]


COVARS_FENOS_CONTINUOS_PREPUBER <- COVARS_FENOS_CONTINUOS_t0[which(!is.na(COVARS_FENOS_CONTINUOS_t0$Cole_Time)),]
...
cor(as.numeric(COVARS_FENOS_CONTINUOS_PREPUBER$BATCH),as.numeric(COVARS_FENOS_CONTINUOS_PREPUBER$Sex_Time))
[1] 0.7162705
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBESIDAD_NO_solapando_OBOW/NormopesoVSSobrepeso_PUBER_adjusted_LEUCOS_AGE_SEX_rawP0001.csv", row.names=FALSE)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBESIDAD_NO_solapando_OBOW/NormopesoVSObeso_PUBER_adjusted_LEUCOS_AGE_SEX_rawP0001.csv", row.names=FALSE)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBESIDAD_NO_solapando_OBOW/SobrepesoVSObeso_PUBER_adjusted_LEUCOS_AGE_SEX_rawP0001.csv", row.names=FALSE)
...
OBESIDAD__[ which(OBESIDAD__ == "Sobrepeso_T2") ] <- "Obeso_T2"
table(OBESIDAD__)
OBESIDAD__ <- factor(OBESIDAD__)
OBESIDAD__


factored.design = model.matrix(~ OBESIDAD__ + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD8T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD4T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.NK + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Bcell + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Mono + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Neu + COVARS_FENOS_CONTINUOS_PREPUBER$Sex_Time + COVARS_FENOS_CONTINUOS_PREPUBER$Age_Time+ COVARS_FENOS_CONTINUOS_PREPUBER$BATCH + factor(COVARS_FENOS_CONTINUOS_PREPUBER$Origen_T1) + HOMA)
data.fit = lmFit(MICROARRAY_PREPUBER,factored.design)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBESIDAD_solapando_OBOW/NormopesoVSOWyObeso_PUBER_adjusted_LEUCOS_AGE_SEX_rawP0001.csv", row.names=FALSE)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBESIDAD_solapando_OBOW/IR_VS_NOIR_PUBER_adjusted_LEUCOS_AGE_SEX_rawP0001.csv", row.names=FALSE)
...
HOMAOB
NoIR_Normopeso_T2 NoIR_Sobrepeso_T2   IR_Sobrepeso_T2     NoIR_Obeso_T2 
               47                28                 8                22 
      IR_Obeso_T2 
               23 
...
factored.design = model.matrix(~ 0 + HOMAOB + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD8T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD4T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.NK + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Bcell + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Mono + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Neu + COVARS_FENOS_CONTINUOS_PREPUBER$Sex_Time + COVARS_FENOS_CONTINUOS_PREPUBER$Age_Time + COVARS_FENOS_CONTINUOS_PREPUBER$BATCH + factor(COVARS_FENOS_CONTINUOS_PREPUBER$Origen_T1))
colnames(factored.design)[1:5] <- c("NoIRNormopeso","NoIRSobrepeso","IRSobrepeso","NoIRObeso","IRObeso")
 colnames(factored.design)[6:16]  <- c("CD8T","CD4T","NK","BCELL","MONO","NEU","SEX","AGE","BATCH","ORIGEN1","ORIGEN2")
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBIR_UNIDOS/NoIRNormopesoVSNoIRSobrepeso_PUBER_adjusted_LEUCOS_AGE_SEX_rawP0001.csv", row.names=FALSE)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBIR_UNIDOS/NoIRNormopesoVSIRSobrepeso_PUBER_adjusted_LEUCOS_AGE_SEX_FDR05andrawP0001.csv", row.names=FALSE)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBIR_UNIDOS/NoIRNormopesoVSNoIRObeso_PUBER_adjusted_LEUCOS_AGE_SEX_rawP0001.csv", row.names=FALSE)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBIR_UNIDOS/NoIRNormopesoVSIRObeso_PUBER_adjusted_LEUCOS_AGE_SEX_rawP0001.csv", row.names=FALSE)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBIR_UNIDOS/NoIRSobrepesoVSIRSobrepeso_PUBER_adjusted_LEUCOS_AGE_SEX_FDR05andrawP0001.csv", row.names=FALSE)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBIR_UNIDOS/NoIRSobrepesoVSNoIRObeso_PUBER_adjusted_LEUCOS_AGE_SEX_rawP0001.csv", row.names=FALSE)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBIR_UNIDOS/NoIRSobrepesoVSIRObeso_PUBER_adjusted_LEUCOS_AGE_SEX_rawP0001.csv", row.names=FALSE)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBIR_UNIDOS/IRSobrepesoVSNoIRObeso_PUBER_adjusted_LEUCOS_AGE_SEX_FDR05rawP0001.csv", row.names=FALSE)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBIR_UNIDOS/IRSobrepesoVSIRObeso_PUBER_adjusted_LEUCOS_AGE_SEX_FDR05rawP0001.csv", row.names=FALSE)
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/GRUPOS_OBIR_UNIDOS/NoIRObesoVSIRObeso_PUBER_adjusted_LEUCOS_AGE_SEX_rawP0001.csv", row.names=FALSE)
...
MICROARRAY_PREPUBER <- MICROARRAY[,-unique(c(which(is.na(COVARS_FENOS_CONTINUOS_t0$DIETARY_QUALITY_INDEX)),which(is.na(COVARS_FENOS_CONTINUOS_t0$Diet_quality_total)),which(is.na(COVARS_FENOS_CONTINUOS_t0$Diet_diversity)),which(is.na(COVARS_FENOS_CONTINUOS_t0$Dietary_equilibrium)),which(is.na(COVARS_FENOS_CONTINUOS_t0$SUM_MDS_Zscore_FINAL)),which(is.na(COVARS_FENOS_CONTINUOS_t0$Total_tMDS)),which(is.na(COVARS_FENOS_CONTINUOS_t0$tMDS_high_adherence_50p)),which(is.na(COVARS_FENOS_CONTINUOS_t0$SUM_KIDMED)),which(is.na(COVARS_FENOS_CONTINUOS_t0$BMIz__Orbegozo__Time))))]


COVARS_FENOS_CONTINUOS_PREPUBER <- COVARS_FENOS_CONTINUOS_t0[-unique(c(which(is.na(COVARS_FENOS_CONTINUOS_t0$DIETARY_QUALITY_INDEX)),which(is.na(COVARS_FENOS_CONTINUOS_t0$Diet_quality_total)),which(is.na(COVARS_FENOS_CONTINUOS_t0$Diet_diversity)),which(is.na(COVARS_FENOS_CONTINUOS_t0$Dietary_equilibrium)),which(is.na(COVARS_FENOS_CONTINUOS_t0$SUM_MDS_Zscore_FINAL)),which(is.na(COVARS_FENOS_CONTINUOS_t0$Total_tMDS)),which(is.na(COVARS_FENOS_CONTINUOS_t0$tMDS_high_adherence_50p)),which(is.na(COVARS_FENOS_CONTINUOS_t0$SUM_KIDMED)),which(is.na(COVARS_FENOS_CONTINUOS_t0$BMIz__Orbegozo__Time))))
,]
...
###### DQI TOTAL ajustando por todo

factored.design = model.matrix(~ COVARS_FENOS_CONTINUOS_PREPUBER$DIETARY_QUALITY_INDEX + COVARS_FENOS_CONTINUOS_PREPUBER$BMIz__Orbegozo__Time + COVARS_FENOS_CONTINUOS_PREPUBER$HOMA_Time + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD8T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD4T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.NK + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Bcell + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Mono + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Neu + COVARS_FENOS_CONTINUOS_PREPUBER$Sex_Time + COVARS_FENOS_CONTINUOS_PREPUBER$Age_Time+ COVARS_FENOS_CONTINUOS_PREPUBER$BATCH + as.factor(COVARS_FENOS_CONTINUOS_PREPUBER$Origen_T1))
colnames(factored.design)[2:4] <- c("DIETARY_QUALITY_INDEX","BMIzscore","HOMA")
 colnames(factored.design)[5:15]  <- c("CD8T","CD4T","NK","BCELL","MONO","NEU","SEX","AGE","BATCH","Origin1","Origin2")

data.fit = lmFit(MICROARRAY_PREPUBER,factored.design)
colnames(data.fit)


fit2 <- eBayes(data.fit)
data.fit.eb <- fit2
summary(decideTests(data.fit.eb))
...
DMPs_significants <- subset(DMPs, P.Value < 0.001)
#DMPs_significants <- subset(DMPs, adj.P.Val < 0.05)
dim(DMPs_significants)
1396
DMPs_significants$UCSC_RefGene_Name

table(gsub("\\;.*","",DMPs_significants$UCSC_RefGene_Name) %in% c("CDK5","NFAM1","SLCO5A1","TCF7L2","VAC14"))

gsub("\\;.*","",DMPs_significants$UCSC_RefGene_Name)[which(gsub("\\;.*","",DMPs_significants$UCSC_RefGene_Name) %in% c("CDK5","NFAM1","SLCO5A1","TCF7L2","VAC14"))]
#"CDK5"   

write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/Dieta/ANALISIS_METILACION_VS_DQI_TOTAL_ajust_edadsexbmihomaloteleucosorigen.csv", row.names=FALSE)
...
###### SUM_MDS_Zscore_FINAL TOTAL ajustando por todo

factored.design = model.matrix(~ COVARS_FENOS_CONTINUOS_PREPUBER$SUM_MDS_Zscore_FINAL + COVARS_FENOS_CONTINUOS_PREPUBER$BMIz__Orbegozo__Time + COVARS_FENOS_CONTINUOS_PREPUBER$HOMA_Time + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD8T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD4T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.NK + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Bcell + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Mono + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Neu + COVARS_FENOS_CONTINUOS_PREPUBER$Sex_Time + COVARS_FENOS_CONTINUOS_PREPUBER$Age_Time+ COVARS_FENOS_CONTINUOS_PREPUBER$BATCH + as.factor(COVARS_FENOS_CONTINUOS_PREPUBER$Origen_T1))
colnames(factored.design)[2:4] <- c("DIETARY_QUALITY_INDEX","BMIzscore","HOMA")
 colnames(factored.design)[5:15]  <- c("CD8T","CD4T","NK","BCELL","MONO","NEU","SEX","AGE","BATCH","Origin1","Origin2")
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/Dieta/ANALISIS_METILACION_VS_SUM_MDS_Zscore_FINAL_TOTAL_ajust_edadsexbmihomaloteleucosorigen.csv", row.names=FALSE)
...
###### Total_tMDS TOTAL ajustando por todo

factored.design = model.matrix(~ COVARS_FENOS_CONTINUOS_PREPUBER$Total_tMDS + COVARS_FENOS_CONTINUOS_PREPUBER$BMIz__Orbegozo__Time + COVARS_FENOS_CONTINUOS_PREPUBER$HOMA_Time + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD8T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD4T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.NK + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Bcell + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Mono + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Neu + COVARS_FENOS_CONTINUOS_PREPUBER$Sex_Time + COVARS_FENOS_CONTINUOS_PREPUBER$Age_Time+ COVARS_FENOS_CONTINUOS_PREPUBER$BATCH + as.factor(COVARS_FENOS_CONTINUOS_PREPUBER$Origen_T1))
colnames(factored.design)[2:4] <- c("DIETARY_QUALITY_INDEX","BMIzscore","HOMA")
 colnames(factored.design)[5:15]  <- c("CD8T","CD4T","NK","BCELL","MONO","NEU","SEX","AGE","BATCH","Origin1","Origin2")
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/Dieta/ANALISIS_METILACION_VS_Total_tMDS_TOTAL_ajust_edadsexbmihomaloteleucosorigen.csv", row.names=FALSE)
...
###### tMDS_high_adherence_50p TOTAL ajustando por todo

factored.design = model.matrix(~ COVARS_FENOS_CONTINUOS_PREPUBER$tMDS_high_adherence_50p + COVARS_FENOS_CONTINUOS_PREPUBER$BMIz__Orbegozo__Time + COVARS_FENOS_CONTINUOS_PREPUBER$HOMA_Time + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD8T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD4T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.NK + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Bcell + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Mono + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Neu + COVARS_FENOS_CONTINUOS_PREPUBER$Sex_Time + COVARS_FENOS_CONTINUOS_PREPUBER$Age_Time+ COVARS_FENOS_CONTINUOS_PREPUBER$BATCH + as.factor(COVARS_FENOS_CONTINUOS_PREPUBER$Origen_T1))
colnames(factored.design)[2:4] <- c("DIETARY_QUALITY_INDEX","BMIzscore","HOMA")
 colnames(factored.design)[5:15]  <- c("CD8T","CD4T","NK","BCELL","MONO","NEU","SEX","AGE","BATCH","Origin1","Origin2")
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/Dieta/ANALISIS_METILACION_VS_tMDS_high_adherence_50p_TOTAL_ajust_edadsexbmihomaloteleucosorigen.csv", row.names=FALSE)
...
###### SUM_KIDMED TOTAL ajustando por todo

factored.design = model.matrix(~ COVARS_FENOS_CONTINUOS_PREPUBER$SUM_KIDMED + COVARS_FENOS_CONTINUOS_PREPUBER$BMIz__Orbegozo__Time + COVARS_FENOS_CONTINUOS_PREPUBER$HOMA_Time + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD8T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.CD4T + COVARS_FENOS_CONTINUOS_PREPUBER$counts.NK + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Bcell + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Mono + COVARS_FENOS_CONTINUOS_PREPUBER$counts.Neu + COVARS_FENOS_CONTINUOS_PREPUBER$Sex_Time + COVARS_FENOS_CONTINUOS_PREPUBER$Age_Time+ COVARS_FENOS_CONTINUOS_PREPUBER$BATCH + as.factor(COVARS_FENOS_CONTINUOS_PREPUBER$Origen_T1))
colnames(factored.design)[2:4] <- c("DIETARY_QUALITY_INDEX","BMIzscore","HOMA")
 colnames(factored.design)[5:15]  <- c("CD8T","CD4T","NK","BCELL","MONO","NEU","SEX","AGE","BATCH","Origin1","Origin2")
...
write.csv2(DMPs_significants, file="/home/augusto/Descargas/ALL_EPIC_ARRAY_DATA_PUBMEP/PRIMER_ANALISIS/RESULTADOS_ANALISIS/SCRIPT3_PUBERTAL/Dieta/ANALISIS_METILACION_VS_SUM_KIDMED_TOTAL_ajust_edadsexbmihomaloteleucosorigen.csv", row.names=FALSE)
